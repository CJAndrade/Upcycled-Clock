...
import weather_condition,sensor_values

consumer_key = "XXXXXXXXXXXXXXXXXXXXXXXXXXXX"
consumer_secret = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
access_token_key = "XXXXXXXXXXXX-XXXXXXXXXXXXXXXXXXXXX"
...
def speak():
    ...
    sensorText = 'Welcome back home, the temperature at home is ' +str(temperature) + ' degrees celsius '
    ...
    weatherText = ' and Todays weather in the evening is ' + str(outCondition) + ' and the temperature is ' + str(outTemp) + ' degrees celsius and humidity of ' + str(outHumidity) + '  percentage'
